...
const translations = {
  en: {
    ...
    seeAll: 'See all',
    chatNow: 'Chat Now',
    matchWithAiAdvisor: 'Match with AI Advisor',
    matchNow: 'Match now',
    ...
    changePasswordDescription: 'Change your current password to a new one to keep your account secure.',
  ...
  bn: {
    ...
    seeAll: 'সব দেখুন',
    chatNow: 'চ্যাট করুন',
    matchWithAiAdvisor: 'AI অ্যাডভাইসরের সাথে ম্যাচ করুন',
    matchNow: 'ম্যাচ করুন',
